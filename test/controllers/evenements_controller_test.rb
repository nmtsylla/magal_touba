...
class EvenementsControllerTest < ActionController::TestCase
  ...
  test "should create evenement" do
    assert_difference('Evenement.count') do
      post :create, evenement: { descriptif: @evenement.descriptif, latitude: @evenement.latitude, lieu: @evenement.lieu, longitude: @evenement.longitude, status: @evenement.status, titre: @evenement.titre }
    end
  ...
  test "should update evenement" do
    patch :update, id: @evenement, evenement: { descriptif: @evenement.descriptif, latitude: @evenement.latitude, lieu: @evenement.lieu, longitude: @evenement.longitude, status: @evenement.status, titre: @evenement.titre }
    assert_redirected_to evenement_path(assigns(:evenement))
  end
