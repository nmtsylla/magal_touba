...
class RubriquesControllerTest < ActionController::TestCase
  ...
  test "should create rubrique" do
    assert_difference('Rubrique.count') do
      post :create, rubrique: { descriptif: @rubrique.descriptif, status: @rubrique.status, titre: @rubrique.titre }
    end
  ...
  test "should update rubrique" do
    patch :update, id: @rubrique, rubrique: { descriptif: @rubrique.descriptif, status: @rubrique.status, titre: @rubrique.titre }
    assert_redirected_to rubrique_path(assigns(:rubrique))
  end
